...
internal static class Program
{
    ...
    {
        var cli = new BasinCommand("A Windows 1.x tiling window manager, running as a client of river or Inlet.");
        var socketOption = cli.Add(CommonOptions.Socket());
        var configOption = cli.Add(new Option<bool>("--config")
        {
            Description = "read ~/.config/retro-wm/retro-wm.toml, otherwise use the built-in defaults",
