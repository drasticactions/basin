...
internal static class Program
{
    ...
    {
        var cli = new BasinCommand("A BeOS/Haiku floating window manager with the Deskbar, running as a client of river or Inlet.");
        var socketOption = cli.Add(CommonOptions.Socket());
        var configOption = cli.Add(new Option<bool>("--config")
        {
            Description = "read ~/.config/deskbar-wm/deskbar-wm.toml, otherwise use the built-in defaults",
