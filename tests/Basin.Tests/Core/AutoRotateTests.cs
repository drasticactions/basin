...
public sealed class AutoRotateTests
{
    ...
    private static (LayoutOutputConfiguration Configuration, FakeOrientation Sensor, TestEdidOutput Panel, OutputLayout Layout) Compose()
    {
        ...
        var configuration = new LayoutOutputConfiguration(layout) { Orientation = sensor };
